    ...
    <Container className='p-4 text-center'>
      <Row>
        <Col lg={4} md={6} sm={12} className="m-auto">
          <form onSubmit={handleSubmit} className='shadow p-3 rounded mt-4'>
            ...
            <hr />
            <Button variant="primary btn-block" onClick={handleGoogleSignIn}><FontAwesomeIcon icon={faGoogle} /> Signin with Google</Button>
